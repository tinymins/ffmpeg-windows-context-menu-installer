...
:: 获取批处理文件的路径
for %%I in ("%~dp0converter.mp4.h264.vbr-10000-15000.seq.bat") do set "scriptPath=%%~fI"
...
for %%F in (%fileTypes%) do (
    ...
    set "subKeyName=HKCR\SystemFileAssociations\%%F\shell\FFmpeg convert to...\shell\MP4 H.264 VBR-10000-15000"
    ...
    :: 创建二级菜单注册表键
    reg add "!subKeyName!" /v "MUIVerb" /t REG_SZ /d "MP4 H.264 VBR-10000-15000" /f
